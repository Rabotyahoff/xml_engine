/*
  ...
  2010.06.07 RA add cache xsl and xml
*/


(function($) {
  var transform_cache_xsl=new Array();//RA
  var transform_cache_xml=new Array();//RA

  $.transform_cache_set_xml=function (xml_, str_){transform_cache_xml[xml_]=str_;}
  $.transform_cache_set_xsl=function (xsl_, str_){transform_cache_xsl[xsl_]=str_;}  
  
  $.transform_cache_del_xml=function (xml_){transform_cache_xml[xml_]=null;}
  $.transform_cache_del_xsl=function (xsl_){transform_cache_xsl[xsl_]=null;}
	...
	$.transform = function(o) {
      ...
      cacheXml : false,//RA
      cacheNetXsl : true,//RA
      cacheNetXml : false,//RA      
			async : true,
			xsl : false,
			xml : false,
      xmlAddToDOM : false,//RA
			xslstr : false,
			xmlstr : false,
			xslobj : false,
			xmlobj : false,
    ...
    if (t.c.cacheXsl==true && transform_cache_xsl[t.c.xsl]!=null){
      t.c.xslstr=transform_cache_xsl[t.c.xsl];
      t.c.xsl=false;
    }
    if (t.c.cacheXml==true && transform_cache_xml[t.c.xml]!=null){
      t.c.xmlstr=transform_cache_xml[t.c.xml];
      t.c.xml=false;
    }
		...
		var replaceref = function(val, o) {
			o.c.xslPath = o.c.xslPath?o.c.xslPath:"";
			var c = location.protocol == "file:" && $.browser.msie ? "\\" : "/";
			var path1 = location.protocol + c + c + location.host;
			var path2 = location.pathname.substring(0,location.pathname.lastIndexOf(c) + 1) + o.c.xslPath.substring(0,o.c.xslPath.lastIndexOf("/") + 1);
      ...
      /*Begin RA*/
        ...
        res=path1+o.c.xslPath.substring(0,o.c.xslPath.lastIndexOf("/") + 1)+val.substring(2,val.length);
      }      
      /*End RA*/
			else {
				res=path1 + path2 + val;
      ...
      return res;
        ...
        var tmp_str=o.c.xmlstr;
        //add info to XML DOM
        if (o.c.xmlAddToDOM!==false){
          var nom=tmp_str.search('>');
          if (nom >= 0) {
            var s_left = tmp_str.substr(0, nom+1);
            var s_right = tmp_str.substr(nom+1,tmp_str.length);
            tmp_str=s_left+o.c.xmlAddToDOM+s_right;
          }          
        }
				o.c.xmlobj = o.c.xmlobj ? o.c.xmlobj : createXmlObj(tmp_str);
		...
		var makeCall = function(t,options,type,cache) {
			if(typeof(options) == "string") {
				options = {
					cache:cache, //false,//RA
					url:options,
					dataType:"xml",
					async:t.c.async,
					pass:t.c.pass
			...
			options.complete = function(r,s) {
				...
				if(type == "XSL") { 
          if(r.status == 200) { t.c.xslstr = r.responseText; } else { t.c.xslstr = "error"; t.c.throwerror=true; }
          //RA
          if (t.c.cacheXsl==true){
            transform_cache_xsl[t.c.xsl]=t.c.xslstr;
          }
        }
				else { 
          if(r.status == 200) { t.c.xmlstr = r.responseText;} else { t.c.xmlstr = "error"; t.c.throwerror=true; }
          //RA
          if (t.c.cacheXml==true){
            transform_cache_xml[t.c.xml]=t.c.xmlstr;
          }          
        }
		...
		if(t.c.xsl) {
			makeCall(t,o.xsl,"XSL",t.c.cacheNetXsl);
		}
		
		if(t.c.xml) {
			makeCall(t,o.xml,"XML",t.c.cacheNetXml);
		}
