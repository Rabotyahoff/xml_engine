...
class DB_Sql {
  ...
  function connect($Database = "", $Host = "", $User = "", $Password = "") {
    ...
    if ( 0 == $this->Link_ID ) {
      ...
      /*mysql_query("SET character_set_database='utf8'",$this->Link_ID);
      mysql_query("SET character_set_server='utf8'",$this->Link_ID);
      mysql_query("SET character_set_system='utf8'",$this->Link_ID);*/
    }
